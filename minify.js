...
const minify = async () => {
	...
	await minifyFile("./webpage/login.js", generateJSOptions(["getBulkInfo", "getBulkUsers", "handleEndpoint", "adduser", "getAPIURLs", "checkInstance", "setTheme"]))
	...
	await minifyFile("./webpage/role.js", generateJSOptions(["Role", "RoleList", "PermissionToggle"]))
	await minifyFile("./webpage/service.js", generateJSOptions())
	await minifyFile("./webpage/settings.js", generateJSOptions(["Settings", "Form", "Options", "Buttons"]))
